...
const _excluded = ["aria-describedby", "aria-label", "aria-labelledby", "autoComplete", "autoFocus", "className", "color", "component", "components", "componentsProps", "defaultValue", "disabled", "endDecorator", "fullWidth", "error", "id", "name", "onClick", "onChange", "onKeyDown", "onKeyUp", "onFocus", "onBlur", "placeholder", "readOnly", "required", "type", "startDecorator", "size", "value", "variant"];
...
const Input = /*#__PURE__*/React.forwardRef(function Input(inProps, ref) {
  var _componentsProps$root, _componentsProps$root2, _components$Input, _componentsProps$inpu, _componentsProps$inpu2;
  ...
  const rootStateClasses = (0, _clsx.default)(disabledState && _inputClasses.default.disabled, errorState && _inputClasses.default.error, focused && _inputClasses.default.focused, Boolean(formControlContext) && _inputClasses.default.formControl);
  const inputStateClasses = (0, _clsx.default)(disabledState && _inputClasses.default.disabled);
  ...
  const Root = component != null ? component : InputRoot;
  const rootProps = (0, _utils2.appendOwnerState)(Root, (0, _extends2.default)({}, getRootProps((0, _extends2.default)({}, other, componentsProps.root)), {
    className: (0, _clsx.default)(classes.root, rootStateClasses, className, (_componentsProps$root = componentsProps.root) == null ? void 0 : _componentsProps$root.className)
  }), ownerState);
  rootProps.ref = (0, _utils.unstable_useForkRef)(ref, (0, _utils.unstable_useForkRef)(rootProps.ref, (_componentsProps$root2 = componentsProps.root) == null ? void 0 : _componentsProps$root2.ref));
  const InputComponent = (_components$Input = components.Input) != null ? _components$Input : InputInput;
  const inputProps = (0, _utils2.appendOwnerState)(InputComponent, (0, _extends2.default)({}, getInputProps((0, _extends2.default)({}, componentsProps.input, propsToForward)), {
    className: (0, _clsx.default)(classes.input, inputStateClasses, (_componentsProps$inpu = componentsProps.input) == null ? void 0 : _componentsProps$inpu.className)
  }), ownerState);
  inputProps.ref = (0, _utils.unstable_useForkRef)((_componentsProps$inpu2 = componentsProps.input) == null ? void 0 : _componentsProps$inpu2.ref, inputProps.ref);
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(Root, (0, _extends2.default)({}, rootProps, {
    children: [startDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(InputStartDecorator, {
      className: classes.startDecorator,
      ownerState: ownerState,
      children: startDecorator
    }), /*#__PURE__*/(0, _jsxRuntime.jsx)(InputComponent, (0, _extends2.default)({}, inputProps)), endDecorator && /*#__PURE__*/(0, _jsxRuntime.jsx)(InputEndDecorator, {
