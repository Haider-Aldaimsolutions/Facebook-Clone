...
const _excluded = ["children", "className", "action", "component", "role", "selected", "color", "variant"];
...
const ListItemButtonRoot = (0, _styles.styled)('div', {
  ...
  return [(0, _extends2.default)({}, ownerState.selected && {
    ...
    paddingInlineStart: 'calc(var(--List-item-paddingLeft) + var(--List-item-startActionWidth, var(--internal-startActionWidth, 0px)) - var(--variant-borderWidth))',
    // --internal variable makes it possible to customize the actionWidth from the top List
    paddingInlineEnd: 'calc(var(--List-item-paddingRight) + var(--List-item-endActionWidth, var(--internal-endActionWidth, 0px)) - var(--variant-borderWidth))',
    // --internal variable makes it possible to customize the actionWidth from the top List
...
const ListItemButton = /*#__PURE__*/React.forwardRef(function ListItemButton(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(ListItemButtonRoot, (0, _extends2.default)({
    as: component,
