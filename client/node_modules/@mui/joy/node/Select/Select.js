...
const SelectRoot = (0, _styles.styled)('div', {
  ...
  var _theme$vars$palette, _theme$variants$, _theme$variants$2, _theme$variants$3;

  return [(0, _extends2.default)({
    '--Select-radius': theme.vars.radius.sm,
    // radius is used by the decorator children
    '--Select-gap': '0.5rem',
    ...
    minWidth: 0,
    // forces the Select to stay inside a container by default
    ...
    transition: 'background-color 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, border-color 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms, box-shadow 250ms cubic-bezier(0.4, 0, 0.2, 1) 0ms',
    '&:before': {
      boxSizing: 'border-box',
      content: '""',
      display: 'block',
...
const SelectListbox = (0, _styles.styled)(_List.ListRoot, {
  ...
  return (0, _extends2.default)({
    ...
    '--List-item-stickyBackground': (variantStyle == null ? void 0 : variantStyle.backgroundColor) || (variantStyle == null ? void 0 : variantStyle.background) || theme.vars.palette.background.surface // for sticky List
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsxs)(React.Fragment, {
    children: [/*#__PURE__*/(0, _jsxRuntime.jsxs)(SelectRoot, (0, _extends2.default)({}, rootProps, {
      ...
      children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_SelectUnstyled.SelectUnstyledContext.Provider, {
        value: context,
        children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_RowListContext.default.Provider, {
          value: false,
