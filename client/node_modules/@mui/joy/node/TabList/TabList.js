...
const TabList = /*#__PURE__*/React.forwardRef(function TabList(inProps, ref) {
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_RowListContext.default.Provider, {
    value: row,
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(TabListRoot, (0, _extends2.default)({}, tabsListRootProps, {
      children: React.Children.map(processedChildren, (child, index) => /*#__PURE__*/React.isValidElement(child) ? /*#__PURE__*/React.cloneElement(child, (0, _extends2.default)({}, index === 0 && {
        'data-first-child': ''
      })) : child)
    }))
  });
